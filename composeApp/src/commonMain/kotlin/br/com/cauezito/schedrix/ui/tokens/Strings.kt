...
internal object Strings {
    ...
    const val CONFIRMATION_SECTION_INPUT_PASSWORD = "Password"
    const val CONFIRMATION_SECTION_INPUT_LOGIN = "Login"
    const val CONFIRMATION_SECTION_CTA_FORGOT_PASSWORD = "Forgot password?"
    const val CONFIRMATION_SECTION_CTA_CREATE_ACCOUNT = "Create an account"
